  ...
  <header class="sticky top-0 z-30 bg-paper/90 backdrop-blur border-b border-ink/10">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <a href="{{ route('travel.index') }}" class="p-2 -ml-2 rounded-lg hover:bg-ink/5 transition-colors" aria-label="戻る">
...
<nav class="fixed bottom-0 w-full z-50 bg-[#334155] shadow-[0_-4px_20px_-4px_rgba(30,58,138,0.15)] flex justify-around items-center h-20 px-4 pb-2 border-t border-slate-600/40">
  <a href="{{ route('travel.index') }}" class="flex flex-col items-center justify-center gap-1 text-white/70 hover:text-white px-4 py-1 active:scale-90 transition-all duration-200">
