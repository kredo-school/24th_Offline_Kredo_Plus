...
<title>Restaurant & Cafe — Kredo Plus</title>
    ...
    <aside id="sidebar" class="hidden md:block w-60 shrink-0">
      <div class="sticky top-24">
        ...
        <nav class="flex flex-col gap-1 pl-5" id="storeNav">
          <a href="#" data-tag="Restaurant" style="--cat-color:#2f5fdb" class="cat-link active flex items-center justify-between py-2 text-sm text-ink/70 hover:text-ink">Restaurant</a>
          <a href="#" data-tag="Cafe" style="--cat-color:#e05237" class="cat-link flex items-center justify-between py-2 text-sm text-ink/70 hover:text-ink">Cafe</a>
        </nav>
      </div>
    </aside>
