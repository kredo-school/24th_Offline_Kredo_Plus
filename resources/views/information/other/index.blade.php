...
<div class="min-h-screen flex flex-col">
  ...
  <div class="max-w-7xl w-full mx-auto px-4 sm:px-6 pt-6">
    ...
    <div class="relative h-52 sm:h-64 rounded-3xl overflow-hidden shadow-[0_1px_2px_rgba(36,30,26,0.06),0_8px_24px_-12px_rgba(36,30,26,0.18)]">
      ...
      <div class="relative h-full flex flex-col justify-end p-6 sm:p-8">
        ...
        <p class="text-white/85 mt-1 text-sm sm:text-base">Everyday essentials for student life: laundry, money exchange, SIM cards, and more.</p>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl w-full mx-auto px-4 sm:px-6 pt-3 md:pt-8">
    ...
    <div class="flex md:hidden gap-2 overflow-x-auto pb-1 mb-2" id="storeNavMobile" style="scrollbar-width:none;">
      <a href="#" data-tag="Laundry" style="--cat-color:#2f5fdb" class="cat-link-mobile active shrink-0 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-semibold transition-colors">Laundry</a>
      <a href="#" data-tag="Money Exchange" style="--cat-color:#e05237" class="cat-link-mobile shrink-0 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-semibold transition-colors">Money Exchange</a>
      <a href="#" data-tag="SIM Card" style="--cat-color:#f5b52e" class="cat-link-mobile shrink-0 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-semibold transition-colors">SIM</a>
      <a href="#" data-tag="Hospital" style="--cat-color:#5eab35" class="cat-link-mobile shrink-0 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-semibold transition-colors">Hospital</a>
      <a href="#" data-tag="Others" style="--cat-color:#7c6ba6" class="cat-link-mobile shrink-0 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-semibold transition-colors">Others</a>
    </div>
  </div>
...
<script>
  ...
  const routeBase = @json(url('information/other'));
