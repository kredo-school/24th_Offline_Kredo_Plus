...
<head>
    ...
    <style>
        ...
        body.loaded .fade-up-1 {
            animation-delay: .10s;
        }

        body.loaded .fade-up-2 {
            animation-delay: .20s;
        }

        body.loaded .fade-up-3 {
            animation-delay: .32s;
        }
        ...
        #intro.leave {
            animation: curtainUp .8s cubic-bezier(.76, 0, .24, 1) .1s both;
        }
        ...
        .intro-ribbon-blue {
            animation: ribbonIn .5s cubic-bezier(.34, 1.56, .64, 1) .15s both;
        }

        .intro-ribbon-red {
            animation: ribbonIn .5s cubic-bezier(.34, 1.56, .64, 1) .35s both;
        }

        .intro-ribbon-green {
            animation: ribbonIn .5s cubic-bezier(.34, 1.56, .64, 1) .55s both;
        }

        .intro-plus {
            opacity: 0;
            animation: plusPop .45s cubic-bezier(.34, 1.56, .64, 1) .8s both;
        ...
        .intro-word span {
            ...
            animation: wordUp .6s cubic-bezier(.22, 1, .36, 1) both;
        }
        ...
        .intro-tag {
            opacity: 0;
            animation: tagIn .5s ease 1.4s both;
        }
        ...
        .pg-body {
            animation: pgSway 2.6s ease-in-out infinite;
        ...
        .ot-head {
            animation: otNod 2.2s ease-in-out infinite;
        ...
        .ot-paw {
            animation: otType .24s ease-in-out infinite alternate;
            transform-box: fill-box;
        }
        ...
        .ot-screen-line {
            animation: screenType 2.4s steps(6) infinite;
            stroke-dasharray: 22;
        }
        ...
        @keyframes flyAcross {
            0% {
                transform: translate(-14vw, 26px) rotate(2deg);
            }

            45% {
                transform: translate(46vw, -12px) rotate(-2deg);
            }

            100% {
                transform: translate(114vw, 10px) rotate(2deg);
            }
        }
        ...
        .adv-jeepney-body {
            animation: jiggle .45s ease-in-out infinite;
        }
        ...
        .adv-leg {
            animation: legSwing .55s ease-in-out infinite alternate;
        ...
        .adv-arm {
            animation: armSwing .55s ease-in-out infinite alternate;
        ...
        @keyframes flap {
            ...
            to {
                transform: rotate(0deg) scaleY(.35);
            }
        }
