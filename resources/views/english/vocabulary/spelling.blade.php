...
<div class="flex-grow max-w-container-max mx-auto w-full px-margin-mobile md:px-margin-desktop py-12">
    ...
    <x-english.breadcrumb>
        ...
        <span class="mx-1">/</span>
        <span class="text-blue-950/90 font-semibold">スペル練習</span>
    </x-english.breadcrumb>
    ...
    <div x-data="spellingApp({
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-2">
                <h1 class="text-headline-md font-bold text-blue-950/90">{{ $levelLabel }} スペル練習</h1>
        ...
        <div x-show="!isComplete" class="max-w-2xl mx-auto">
            <div class="bg-surface-container-lowest rounded-[0.75rem] shadow-sm p-8 mb-6">
                <p class="text-caption text-blue-950/90 mb-2">意味のヒント</p>
                <p class="text-headline-md font-bold text-orange-600 mb-4" x-text="current.hint"></p>
                <p class="text-caption text-blue-950/90 mb-1">例文</p>
            ...
            <div x-show="isAnswered" class="space-y-4">
                <div :class="isCorrect ? 'bg-green-50 border-green-200' : 'bg-error-container/30 border-error/20'"
                    ...
                    <p class="mb-2"><span class="material-symbols-outlined !text-3xl" :class="isCorrect ? 'text-green-600' : 'text-error'" x-text="isCorrect ? 'check_circle' : 'cancel'"></span></p>
